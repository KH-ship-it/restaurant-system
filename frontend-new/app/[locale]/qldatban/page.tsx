...
export default function MenuManagement() {
  ...
  // ⚠️ QUAN TRỌNG: Sử dụng environment variable hoặc URL tuyệt đối
  // Để frontend hoạt động trên cả desktop và mobile
  const API_URL = process.env.NEXT_PUBLIC_API_URL 
    ? `${process.env.NEXT_PUBLIC_API_URL}/api/menu`
    : 'http://localhost:8000/api/menu'; // Fallback cho dev local
